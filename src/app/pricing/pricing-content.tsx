...
const packages = [
  {
    ...
    price: "KES 60,000",
    color: "bg-green-500",
    description: "Small businesses, professionals, personal brands",
    timeline: "2–3 weeks",
    features: [
      "5-page responsive website",
      "UI/UX design (custom, not template)",
      "Mobile & tablet optimization",
      "Basic brand styling (colors, typography)",
  ...
  },
  {
    ...
    price: "KES 150,000",
    color: "bg-blue-500",
    description: "Growing businesses, startups, NGOs",
    timeline: "4–6 weeks",
    features: [
  ...
  },
  {
    ...
    price: "KES 300,000",
    color: "bg-purple-500",
    description: "Startups, founders, organizations building digital products",
    timeline: "6–8 weeks",
    features: [
      "Product discovery & UX strategy",
      "MVP UI/UX design (Figma)",
